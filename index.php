    ...
    <div class="content">
        <div class="formules">
            ...
            <div class="formule">
                ...
                <input readonly type="text" class="antwoord" value="Antwoord">
            </div>
            <div class="formule">
            ...
            <form action="" id="FormPercentage">
                ...
                <input readonly type="text" class="antwoordPercentage" value="Antwoord">
                ...
                <input readonly type="text" class="antwoordPercentage2" value="Antwoord">
            </div>
            ...
            <form action="" id="FormGem">
                ...
                <input readonly type="text" class="antwoordGem" value="Antwoord">
            </div>

            <div class="formule">
            <h2> Waarden Omrekenen </h2>
            <p>Hieronder kun je waarden omrekenen naar een andere inhoudseenheid. Je vult in de velden hieronder de verschillende waarden, bijvoorbeeld in meter, waarvan je wilt weten hoeveel het is in bijvoorbeeld liter.</p><br />
            <form action="" id="FormOmr">
                ...
                <input readonly type="text" class="antwoordOmr" value="Antwoord">
                <br />
                ...
                <input readonly type="text" class="antwoordCur ext" value="Antwoord">
            </div>
            <div class="formule">
            ...
            <!-- <input class="test23" type="number"> -->
                ...
                <div class="inputs1">
                    ...
                    <input readonly type="text" class="antwoordPyt" value="Antwoord">
                </div>
                </form>
                ...
                <div class="inputs2">
                    ...
                    <br />
                    <!-- <p> Zijde AB (de rechhoekszijde): </p><input type="number" value="" id="zijde_12" pattern="[0-9]+" class="number">
                    <p> Zijde BC (de schuine zijde): </p><input type="number" value="" id="zijde_22" pattern="[0-9]+" class="number">
                    <p> Zijde CA (de rechhoekszijde): </p><input type="number" value="" id="zijde_32" pattern="[0-9]+" class="number"> <br> -->
                    <button type="button" id="uitr" class="PytAntwoord2">Uitrekenen</button>
                    <input readonly type="text" class="antwoordPyt2" value="Antwoord">
                </div>
                </form>
            </div>
        </div>
